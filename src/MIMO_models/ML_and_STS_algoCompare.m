...
[SNR_STS_algo, Ber_STS_algo] = Replace_Zeros(SNRs, Ber_STS_algo);
...
Plotting_multiple({SNRs, SNRs}, {time_ML_algo, time_STS_algo}, time_names, "SNR dB", "time sec", "Time compare", 1, directory_for_results);


% Plotting curvesof numb clips
Plotting_multiple({SNRs}, {clips_STS_algo}, clip_names, "SNR dB", "numb clips", "Clip compare", 1, directory_for_results);
