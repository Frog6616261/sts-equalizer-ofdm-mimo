...
for idx = 1:LLR_runs
    ...
    iter=1;
     ...
     semilogy(ax, ...
             SNRs_dB(1:LLR_runs), ber_UNQUANTIZED(1,1:LLR_runs), 'b*',...
             SNRs_dB(1:LLR_runs), ber_SD(1,1:LLR_runs), 'k*');
...
%fitBER_LLR = berfit(SNRs_dB(1:LLR_runs),ber_UNQUANTIZED(1,:));
%fitBER_SD = berfit(SNRs_dB(1:LLR_runs),ber_SD(1,:));
%semilogy(ax,SNRs_dB,fitBER_HD,'r*-',SNRs_dB(1:LLR_runs),fitBER_LLR,'b*-', ...
%        SNRs_dB(1:LLR_runs),fitBER_SD,'k*-');
%hold(ax,'off');
